...
schemaJSON.versions[0].objects = del.deleteObjectsFields(
    schemaJSON.versions[0].objects,
    true,
)
schemaJSON.versions[0].scenes = del.deleteObjectsFields(
    schemaJSON.versions[0].scenes,
    false,
)
